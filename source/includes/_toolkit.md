...
Use scripts/check_cross_spec_drift.py to compare the published ODPG schema node and edge terms against ODPV and refresh cross-spec-drift/odpg-odpv-drift.md.
...
| [`check_cross_spec_drift.py`](https://github.com/Open-Data-Product-Initiative/odpv-v1.0/blob/main/scripts/check_cross_spec_drift.py) | Compares the published ODPG schema node and edge terms against ODPV and writes `cross-spec-drift/odpg-odpv-drift.md` |
